...
inextensible, so stores no energy.  This work considered only the
Schwarzschild metric and generalizing it to the Kerr
metric~\cite{kerr1963} might be interesting.
