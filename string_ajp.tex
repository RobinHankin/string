...
\caption{Null geodesics in the Schwarzschild geometry starting~$(r,0)$
  and initially tangential.  Note the differences between these curves
  and the taut strings shown elsewhere: unlike taug strings, null
  geodesics have positive curvature everywhere, may cross the event
  horizon inwards, and are never tangential to the event horizon}
