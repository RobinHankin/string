...
```{r}
 ...
 plot(out$x,out$y,type='l',asp=1,axes=FALSE,xlab='',ylab='',main='Orbit of Mercury')
 event_horizon()
 max(out$phi/(2*pi))
```
...
precession.  To calculate this precession we need to simulate the
motion for a longer time:
...
plot(tee,phi-pi,main='orbital angle at aphelion',xlab='time (seconds)',ylab='angle of aphelion')
```
