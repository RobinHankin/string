...
undergraduate physics students [CITATION NEEDED].  Einstein's concept
of ``curved'' spacetime is an enduring metaphor that attracts large
numbers of undergraduates into courses such as AUT's frontiers of
astronomy courses.

Students are weary of being told that ``space is warped'' and ``not
even light can escape a black hole''.  Students typically stumble on
the concept of warped spacetime on the grounds that torsion-free
metrics are not embedded IN ANYTHING.  

Here I show how numerical methods can be used to interpret the concept
of ``straight line'' in the vicinity of a black hole.  As
\cite{overduin2018} point out, demonstrations of relativistic concepts
using everyday materials (in their case gravitational waves visualised
by oscillations in spandex) can exert a galvanising effect on
students.

Light inextensible strings are a stalwart feature of elementary
physics.  It is perhaps not out of place to point out explicitly that
a light string is not subject to gravity, and its being under tension
means that its configuration is an extremum of proper length.  Of
course, no real string is perfectly weightless or inextensible.  With
tension~$T$, gravitational acceleration $g$ and (proper) mass per
...
Analysis of non-radial strings interprets the concept ``straight
