...
amenable to numerical solution.  Here we consider only strings
exterior to the event horizon, $r>2M$, and for these we have a
well-defined point of closest approach to the event horizon.  Further,
because the system is invariant under~$\phi\longrightarrow-\phi$, the
string must be symmetrical about at this point.
...
geodesics follow $r''=r-3M$.  Thus a taut string would {\em look}
curved to a local observer, having a (visual) radius of curvature of
