...
light inexensible string under tension passing between two points, and consider the extent to which the expression  ``straight line'' would be applicable to such an object.
