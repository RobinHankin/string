...
$r=2GM$ to $r=2GM+w$ where $w>0, \left|w\right|\ll 1$.  Then
...
\begin{equation}
  \ell=\int_{r=2GM}^{r=2GM+w}ds
  =2\sqrt{2GM}w^{1/2} + \frac{w^{3/2}}{3\sqrt{2GM}} + O\left({w}^{5/2}\right)
\end{equation}
...
case $w\gg 2GM$ we have an asymptotic expansion that begins
...
\begin{equation}
  \ell = w +  GM\log\left(\frac{w}{2GM}\right) + GM(1+ 2\log 2)+\frac{GM}{4}w^{-1} + O(w^{-2}),
\end{equation}
